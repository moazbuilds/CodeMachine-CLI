...
<Card title="See Names in Action" icon="arrow-right" href="/build-workflows/workflow-examples">
  View real workflow examples with descriptive names
</Card>
...
<Card title="See Steps in Action" icon="arrow-right" href="/build-workflows/workflow-examples">
  View real workflow examples with step sequences
</Card>
...
<Card title="See Tracks in Action" icon="arrow-right" href="/workflow-examples#tracks">
  View real workflow examples using tracks
</Card>
...
<Card title="See Conditions in Action" icon="arrow-right" href="/workflow-examples#conditions">
  View real workflow examples using conditions
</Card>
...
<Card title="See Sub-Agents in Action" icon="arrow-right" href="/workflow-examples#sub-agents">
...
<Card title="See Controllers in Action" icon="arrow-right" href="/workflow-examples#controller">
...
<Card title="See Modules in Action" icon="arrow-right" href="/workflow-examples#modules">
...
<Card title="See Specifications in Action" icon="arrow-right" href="/workflow-examples#specification">
  View real workflow examples using specifications
</Card>
...
<Card title="See Autonomous Mode in Action" icon="arrow-right" href="/workflow-examples#autonomous-mode">
  View real workflow examples using autonomous mode
</Card>

...
<Steps>
  <Step title="Architect">
    ...
    <Card title="Steps (Chained Prompts)" icon="list-check">
      Deep-dive analysis through Q&A → User → Complete system architecture design → User
    </Card>
  ...
  <Step title="Security Expert">
    ...
    <Card title="Steps (Chained Prompts)" icon="list-check">
      Threat modeling and attack surface analysis →  User → Security controls and mitigation strategy →  User
    </Card>
    <Card title="Output" icon="file-export">
  ...
  <Step title="Senior Engineer">
    ...
    <Card title="Steps (Chained Prompts)" icon="list-check">
      Feasibility analysis → User → Final design incorporating all feedback → User
    </Card>
    <Card title="Output" icon="file-export">
      `final-design.md`
    </Card>

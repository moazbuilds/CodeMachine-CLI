...
import type { WorkflowEventBus, Unsubscribe } from '../../../workflows/events/index.js';
...
export abstract class BaseUIAdapter implements IWorkflowUI {
   ...
   */
  protected abstract handleEvent(event: import('../../../workflows/events/index.js').WorkflowEvent): void;
}

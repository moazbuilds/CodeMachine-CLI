 ...
 *
 * Usage: bun src/pipeline/generate-segments.ts <name>
 *   e.g. bun src/pipeline/generate-segments.ts what-is-this
 */
...
if (!name) {
  console.error("Usage: bun src/pipeline/generate-segments.ts <name>");
  process.exit(1);
}

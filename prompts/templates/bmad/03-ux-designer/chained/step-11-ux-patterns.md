---
name: 'Step 11: UX Consistency Patterns'
description: 'Establish consistency patterns for common UX situations'
---

# Step 11: UX Consistency Patterns

**Progress: Step 11 of 13** - Next: Responsive & Accessibility
...
- Component strategy from step 10 informs pattern decisions
- User journeys from step 9 identify common pattern needs

---
name: 'Step 9: User Journey Flows'
description: 'Design detailed user journey flows for critical user interactions'
---

# Step 9: User Journey Flows

**Progress: Step 9 of 13** - Next: Component Strategy
...
- Design direction from step 8 informs flow layout and visual design
- Core experience from step 6 defines key journey interactions

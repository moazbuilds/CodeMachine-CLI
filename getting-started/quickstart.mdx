...
<Steps>
  ...
  <Step title="Authenticate an Engine">
    ...
    <Info>
      Each workflow specifies which engine(s) it uses. You can override this in the workflow file if needed. [See supported engines →](/resources/engine-compliance)
    </Info>
  </Step>
...
<CardGroup cols={2}>
  <Card title="Core Concepts" icon="book" href="/core-concepts/the-model">
    Understand how CodeMachine works
  </Card>
  <Card title="Workflow Patterns" icon="shuffle" href="/core-concepts/workflow/patterns">

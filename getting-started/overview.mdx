...
<CardGroup cols={3}>
  <Card title="What is CodeMachine?" icon="lightbulb" href="/core-concepts/what-is-codemachine">
    Philosophy and "why" behind the tool
  </Card>
  <Card title="Workflow Definition" icon="diagram-project" href="/core-concepts/workflow/definition">
...
<CardGroup cols={2}>
  ...
  <Card title="Core Concepts" icon="book" href="/core-concepts/what-is-codemachine">

...
CodeMachine currently supports orchestration of these engines:

| Engine | Provider | Terms |
|--------|----------|-------|
| Claude Code | Anthropic | [Terms of Service](https://www.anthropic.com/legal/consumer-terms) |
| Codex | OpenAI | [Terms of Use](https://openai.com/policies/terms-of-use) |
| OpenCode | Open Source | [Repository](https://github.com/opencode-ai/opencode) |

<Info>
  More engines are being added. [Request an engine →](https://github.com/moazbuilds/CodeMachine-CLI/issues)
</Info>
